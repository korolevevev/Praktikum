...
class FileProcessor:
    ...
    def get_cmds() -> Dict[str, str]:
        ...
        cmds = {
            ...
            "ls": "что содержится в папке - вывод",
            "read": "read file",
            "remove": "remove file",
            "cp": "copy file or dir",
            "mv": "move file or dir",
            "write": "write into file",
            "touch": "new unnamed file",
            "cat": "see what file contains",
        }
    ...
    def mkdir(self, name: str):
        ...
        except FileExistsError: print(f"Ошибка: директория {name} существует")
